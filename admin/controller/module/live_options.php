...
class ControllerModuleLiveOptions extends Controller {
	...
	public $special_container 	        = '.price-new';		// in default them it is ".price-new"
	public $price_container				= '.price-old';		// in default them it is ".price-old"
	public $tax_container 		        = '.price-tax';		// in default them it is ".price-tax'"
	public $points_container 			= '.spend-points';	// in default them it is ".price-points'"
	public $reward_container 			= '.get-reward';	// in default them it is ".price-reward'"
	private $error = array();
