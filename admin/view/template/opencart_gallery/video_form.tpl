        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane fade" id="tab-data">
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-video"><span data-toggle="tooltip" title="<b>Eg:</b><br />
              Youtube : youtube.com/watch?v=TJkmc8-eyvE<br />
              Vimeo : vimeo.com/94936857">Video Url</span></label>
                <div class="col-sm-10">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              ...
              <tr>
                ...
                <td><textarea name="video_description[<?php echo $language['language_id']; ?>][description]" id="description<?php echo $language['language_id']; ?>"><?php echo isset($video_description[$language['language_id']]) ? $video_description[$language['language_id']]['description'] : ''; ?></textarea></td>
              </tr>
            </table>
          </div>
          <?php } ?>
        ...
        <div id="tab-data">
          <table class="form">
            <tr>
              <td>video url</td>
              <td><input type="text" name="video" value="<?php echo $video; ?>" size="60" /><br />
              <br /><b>Eg:</b><br />
              Youtube : http://www.youtube.com/watch?v=TJkmc8-eyvE<br />
              Vimeo : http://vimeo.com/94936857
              </td>
            </tr>
            <tr>
