      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-review" class="form-horizontal">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="album" value="<?php echo $album; ?>" placeholder="<?php echo $entry_album; ?>" id="input-album" class="form-control" />
...
$('input[name=\'album\']').autocomplete({
  ...
  'select': function(item) {
    $('input[name=\'album\']').val(item['label']);
    $('input[name=\'album_id\']').val(item['value']);   
  } 
});
//--></script></div>
<?php echo $footer; ?>