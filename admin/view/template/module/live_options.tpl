        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-featured" class="form-horizontal">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab-general">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-use-cache"><?php echo $entry_use_cache; ?></label>
                    <div class="col-sm-10">
                ...
                <div class="tab-pane" id="tab-css-style">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-options-container"><span data-toggle="tooltip" title="<?php echo $help_options_container; ?>"><?php echo $entry_options_container; ?></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-special-container"><span data-toggle="tooltip" title="<?php echo $help_special_container; ?>"><?php echo $entry_special_container; ?></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-price-container"><span data-toggle="tooltip" title="<?php echo $help_price_container; ?>"><?php echo $entry_price_container; ?></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-tax-container"><span data-toggle="tooltip" title="<?php echo $help_tax_container; ?>"><?php echo $entry_tax_container; ?></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-points-container"><span data-toggle="tooltip" title="<?php echo $help_points_container; ?>"><?php echo $entry_points_container; ?></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-reward-container"><span data-toggle="tooltip" title="<?php echo $help_reward_container; ?>"><?php echo $entry_reward_container; ?></label>
                        <div class="col-sm-10">
