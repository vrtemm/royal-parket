                ...
                <div class="tabbable">
                    <div class="tab-navigation form-inline">
                        <ul class="nav nav-tabs mainMenuTabs" id="mainTabs">
							<li><a href="#control_panel" role="tab" data-toggle="tab"><i class="fa fa-power-off"></i>&nbsp;Панель управления</a></li>
                            <li id="blogs_tab"><a href="#blogs" role="tab" data-toggle="tab"><i class="fa fa-file-text"></i>&nbsp;Статьи</a></li>
							<li><a href="#listing" role="tab" data-toggle="tab"><i class="fa fa-indent"></i>&nbsp;Настройки</a></li>
							<li><a href="#posts" role="tab" data-toggle="tab"><i class="fa fa-file-text-o"></i>&nbsp;Список статей</a></li>
                            <li><a href="#isense_support" role="tab" data-toggle="tab"><i class="fa fa-external-link"></i>&nbsp;Поддержка</a></li>
                        </ul>
                        <div class="tab-buttons">
                        	<a id="addNewPost" href="<?php echo $url->link('module/'.$moduleNameSmall.'/newBlogPost', 'token=' . $token."&store_id=".$store['store_id'], 'SSL'); ?>" class="btn btn-info addNewPost"><i class="fa fa-file-text-o"></i>&nbsp;&nbsp;Добавить статью</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <button type="submit" class="btn btn-success save-changes"><i class="fa fa-check"></i>&nbsp;Сохранить</button>
                            <a onclick="location = '<?php echo $cancel; ?>'" class="btn btn-warning"><i class="fa fa-times"></i>&nbsp;Отменить</a>
                        </div> 
                    </div><!-- /.tab-navigation --> 
  ...
  <div class="modal-dialog modal-lg" style="width: 90% !important;margin: 20px auto;">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="addPostModalLabel">Новая статья</h4>
      </div>
      <div class="modal-body" style="overflow:auto;" id="addPostModalBody">
      </div>
      <div class="modal-footer">
		<button class="btn" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i> Закрыть</button>
		<button class="btn btn-primary" id="submitPost"><i class="fa fa-file-text-o"></i>&nbsp;Сохранить</button>
      </div>
    </div>
  </div>
</div>
...
$('.modal-footer').delegate('#submitPost', 'click', function(e){
	...
	var z= true;
	if (!z) {
		alert("Пожалуйста, убедитесь, что вы заполнили все необходимые поля, а затем повторите попытку.");
	} else {
		$.ajax({
