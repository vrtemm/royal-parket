            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                    ...
                    <?php } ?>
					<?php if ($layout_module['position'] == 'content_first') { ?>
                    <option value="content_first" selected="selected">Content top first</option>
                    <?php } else { ?>
                    <option value="content_first">Content top first</option>
                    <?php } ?>
...
function addModule() {
	...
	html += '    <option value="content_first">Content top first</option>';
