          ...
          <table id="images" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr id="image-row<?php echo $image_row; ?>">
                ...
                <td class="text-right"><input type="hidden" name="banner_image[<?php echo $image_row; ?>][video]" value="<?php echo $banner_image['video']; ?>"  /><input type="text" name="banner_image[<?php echo $image_row; ?>][sort_order]" value="<?php echo $banner_image['sort_order']; ?>" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>
...
function addImage() {
	...
	html += '  <td class="text-right"><input type="hidden" name="banner_image[' + image_row + '][video]" value="" class="form-control" /><input type="text" name="banner_image[' + image_row + '][sort_order]" value="" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>';
