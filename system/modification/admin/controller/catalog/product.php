...
class ControllerCatalogProduct extends Controller {
	...
	public function delete() {
 	...
 	public function upload_currency() {
	...
	if ($this->request->server['REQUEST_METHOD'] == 'POST') {
		...
		$currprod = $this->model_catalog_product->getCurrencyProd();
		foreach ($currprod as $val){
		$currency_value = $this->model_catalog_product->getCurrencytest($val['code']);
		
			if(!empty($currency_value)){
			$a['price']=$val['price_currency']/$currency_value['value'];
			}else{
			...
			$data['List'][] = array(
				...
				'weight' => $val['weight'],
				'weight_class_id' => $val['weight_class_id'],
				'length' => $val['length'],
				'date_available' => $val['date_available'],
				'width' => $val['width'],
				'height' => $val['height'],
				'length_class_id' => $val['length_class_id'],
				...
				$this->model_catalog_product->addCurrency($data['List']);
 ...
 $data['upload_currency'] = $this->url->link('catalog/product/upload_currency', 'token=' . $this->session->data['token'] . $url, 'SSL'); 
		$data['products'] = array();
 ...
 $data['entry_currency'] = $this->language->get('entry_currency');
		$data['entry_price_currency'] = $this->language->get('entry_price_currency'); 
 ...
 $data['currencies']=array();
		$currency =	$this->model_catalog_product->getCurrencies();
		...
		if (isset($this->request->get['product_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$product_currency = $this->model_catalog_product->getCurrency($this->request->get['product_id']);
		}
		
		if (isset($this->request->post['price_currency'])) {
			$data['price_currency'] = $this->request->post['price_currency'];
		} elseif (!empty($product_currency)) {
			 $data['price_currency'] =  $product_currency['price_currency']; 
		} else {
		...
		if (isset($this->request->post['code'])) {
			...
			$data['code'] = $product_currency['code'];
		} else {
			$data['code'] = 'non';
		} 
