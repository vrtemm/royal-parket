...
<div id="content">
  ...
  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-currency-class"><?php echo $entry_currency; ?></label>
                <div class="col-sm-10">
                  <select name="code" id="input-currency-class" class="form-control">
                    <option value="non"><?php echo $text_none; ?></option>
				 ...
				 <div class="form-group">
                <label class="col-sm-2 control-label" for="input-price"><?php echo $entry_price_currency; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="price_currency" value="<?php echo $price_currency; ?>" placeholder="<?php echo $entry_price_currency; ?>" id="input-price-currency" class="form-control" />
              </div>
			  </div> 
              <div class="form-group">
