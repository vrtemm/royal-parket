        ...
        <?php
			...
			<div id="content" class="<?php echo $content_width; ?> product_page">
              ...
              <div class="phone-click">
              	<div class="phone-click-img">
                	<img src="/image/catalog/mobile.png"/>
                </div>
                <div class="phone-click-txt">
              		<h3><?php echo $text_one_click_header; ?></h3>
                    <p><?php echo $text_one_click_help; ?></p>
                </div>
              </div>
              <div class="input-group" style="width:100%;">
                ...
                <script type="text/javascript">
                    jQuery(document).ready(function() {
						jQuery("#input-payment-telephone").mask("<?php echo $text_one_click_mask; ?>",{placeholder:"+38(___)___-__-__"});
					});
                </script>
...
<script type="text/javascript"><!--
$('#button-oneclick').on('click', function() {
ga('send', 'pageview', '/virtual/1clicjk'), ga('send', 'event', 'Knopka', '1click');
});
$('#button-oneclick').on('click', function() {
	$.ajax({
		url: 'index.php?route=checkout/one_click/add',
