...
if (!function_exists('getHttpTheme')) {
	function getHttpTheme($options)
	{
		...
		if ((isset($data['settings_general']['seocms_url_secure']) && $data['settings_general']['seocms_url_secure'] == 'https' && $data['settings_general']['seocms_url_secure'] != 'http') || ((isset($_SERVER['HTTPS']) && ($_SERVER['HTTPS'] == 'on' || $_SERVER['HTTPS'] == '1')) || (!empty($_SERVER['HTTP_X_FORWARDED_PROTO']) && (strtolower($_SERVER['HTTP_X_FORWARDED_PROTO']) == 'https') || (!empty($_SERVER['HTTP_X_FORWARDED_SSL']) && $_SERVER['HTTP_X_FORWARDED_SSL'] == 'on'))) && (isset($data['settings_general']['seocms_url_secure']) && (isset($data['settings_general']['seocms_url_secure']) && $data['settings_general']['seocms_url_secure'] != 'http'))) {
