...
<div class="box bestsellers">
    ...
    <div class="box-content">
		<?php if ($is_home) { $clsowl = 'mybestowl'; } ?>
		<div class="row <?php if(isset($clsowl)){echo $clsowl;} ?>">
			...
			<!-- <?php if ($is_home) {?> <div class="oc_after">Все хиты продаж <i class="fa fa-long-arrow-right" aria-hidden="true"></i>
			</div> <?php } ?> -->
		</div>
	</div>
	<script type="text/javascript"><!--
		$('.mybestowl').owlCarousel({
			items: 4,
			autoPlay: 5000,
			navigation: true,
