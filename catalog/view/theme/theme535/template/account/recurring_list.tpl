		  ...
		  <tbody>
			<?php foreach ($recurrings as $recurring) { ?>
			  <tr>
				...
				<td class="text-right"><a href="<?php echo $recurring['href']; ?>"><img src="catalog/view/theme/theme497/image/info.png" alt="<?php echo $button_view; ?>" title="<?php echo $button_view; ?>" /></a></td>
			  </tr>
			<?php } ?>
		  </tbody>
		</table>
