...
<button class="btn btn-danger" data-onclick="removeProduct" data-product-key="<?php echo !empty($product['cart_id']) ? $product['cart_id'] : $product['key'] ?>" data-toggle="tooltip" type="button" style="
...
">
    ...
    font-size: 12px;
    color: #6b6767;
">Арт. <?php echo $product['sku']; ?></small>
                        <?php } ?>
                    </td>
